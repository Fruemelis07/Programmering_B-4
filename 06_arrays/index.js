...
var listeInput, iisteHeading, listeButton, listeContainer
var removeListe
...
function setup(){
    ...
    // Danish: der er et input felt en container og en knap til at tilføje nye elemnter på siden
    ...
    //make a list 
    var elements = ["hest", "dog", "hamster", "php", "kangoro", "fuck", "subway sanwith", "group rat", "bird"]
    // call the geneic function that makes new elemets
    createList(elements, removeListe, 'victims') 
...
//tager to argumenter - hvilken liste den skal gøre noget med og hvor den skal resultere
function createList(liste, destination, className, action) {
